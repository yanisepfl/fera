 ...
 *
 * RainbowKit is themed onto the Fera-Gold dark surface (DESIGN.md tokens) so the modal
...
const feraWalletTheme: Theme = darkTheme({
  accentColor: "#e7b84b", // --accent (Fera Gold)
  accentColorForeground: "#17130a", // --on-accent
  borderRadius: "medium",
  fontStack: "system",
  overlayBlur: "small",
});
