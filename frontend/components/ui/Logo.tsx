 ...
 * `currentColor`, and `color` defaults to `--accent` (Fera Gold), so the mark
 * themes correctly wherever it's dropped in; pass `color` to override (e.g.
 * `var(--on-accent)` on a solid accent background).
 */
