...
/**
 * Open-liquidity framing (D-11 / INV-14) with the D-M13 honesty guardrail baked in.
 *
  ...
  if (compact) {
    return (
      <div className="rounded-lg border border-line bg-well p-3 text-caption text-mute">
        ...
        hook is permissionless (D-11). Only <span className="text-accent">vault</span> deposits
        earn FERA emissions (INV-14). Direct LPs earn swap fees but no esFERA. We don&apos;t
      ...
      <div className="px-5 pb-5 space-y-3">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-line bg-well p-3">
            ...
            <ul className="mt-1.5 space-y-1 text-caption text-dim">
              <li>· Permissionless: pick your own range (D-11)</li>
